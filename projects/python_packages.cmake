...
if(NOT BUILD_OS_WINDOWS)
    ...
    if(BUILD_OS_WIN32)
        add_custom_command(TARGET NumpyScipyShapely PRE_BUILD
            ...
            COMMAND ${Python3_EXECUTABLE} -m pip install https://download.lfd.uci.edu/pythonlibs/w4tscw6k/scipy-1.6.3-cp38-cp38-win32.whl
        ...
        add_custom_command(TARGET NumpyScipyShapely PRE_BUILD
            ...
            COMMAND ${Python3_EXECUTABLE} -m pip install https://download.lfd.uci.edu/pythonlibs/w4tscw6k/scipy-1.6.3-cp38-cp38-win_amd64.whl
